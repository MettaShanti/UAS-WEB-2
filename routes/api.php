...
Route::put("kategori/{id}",[KategoriController::class, 'destroyKategori']);//->middleware('auth:sanctum', 'ability:delete');
...
Route::put("stok/{id}",[StokController::class, 'destroyStok']);//->middleware('auth:sanctum', 'ability:delete');
